...
using Dates #Import module

# TODO create new Date and DateTime
d1=Date(2018, 12, 22)
dt1=DateTime(2019, 7, 28) #Leaving time component out; will show as midnight
println(d1, "\n", dt1) #\n is a new line
...
println(d3-d4) #Time in days
println(dt3-dt4) #Time in milliseconds
